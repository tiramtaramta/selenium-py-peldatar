...
browser.find_element_by_id("example-input-month").send_keys(now_utc.strftime("%Y"))
browser.find_element_by_id("example-input-month").send_keys(Keys.TAB)
browser.find_element_by_id("example-input-month").send_keys(now_utc.strftime("%B"))
